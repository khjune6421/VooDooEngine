...
class Camera
{
	DirectX::XMFLOAT3 m_position = { 0.0f, 2.5f, -5.0f };
...
public:
	Camera(DirectX::XMFLOAT3 position = { 0.0f, 2.5f, -5.0f }, DirectX::XMFLOAT3 rotation = { 0.5f, 0.0f, 0.0f }, int screenWidth = 1920, int screenHeight = 1080, float nearPlane = 0.1f, float farPlane = 1000.0f, float fov = DirectX::XM_PIDIV4);
	~Camera() = default;
