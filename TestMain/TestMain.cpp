...
#endif
{
	...
	VDW::CreateWindowAndRenderer(L"VooDoo Class3", L"VooDoo Engine1", 1280, 720);
	VDW::CreateWindowAndRenderer(L"VooDoo Class4", L"VooDoo Engine2", 1280, 720, 1280, 720, L"../Assets/Imposter/");
