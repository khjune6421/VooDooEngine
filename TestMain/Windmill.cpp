...
{
	AddComponent<Shape>(L"Windmill", L"VertexShader", L"PixelShader", L"Building", L"BuildingNormal");

	m_Wing = make_unique<Object>(scene);
	m_Wing->AddComponent<Shape>(L"WindmillWings", L"VertexShader", L"PixelShader", L"Wood", L"NoNormal");
